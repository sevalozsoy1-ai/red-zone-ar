...
const ENGLISH_COPY = {
  ...
  weaponVolume: 'Weapon sounds',
  effectsVolume: 'Effects',
  musicOn: 'Music on',
  musicOff: 'Music off',
  flashlightOn: 'Flashlight on',
  flashlightOff: 'Flashlight off',
  flashlightUnsupported: 'This device does not support the flashlight.',
  qrFreshTarget: 'QR target confirmed',
  qrRetainedLock: 'Network lock retained',
  qrAutomaticTarget: 'Sole opponent selected automatically',
  qrNoTarget: 'No network target',
  qrClearTarget: 'Clear target',
  qrSwitchTarget: 'Scan another QR to switch target',
  qrTargetHelp: 'A fresh QR scan identifies the target. If the QR is temporarily unreadable, the network lock remains until the target leaves or is cleared.',
  close: 'CLOSE',
...
// These controls are shared by the settings and live battle surfaces.  Keep
// them in the catalogue (rather than branching on the current locale in a
// component) so every supported locale has the same semantic coverage.
const SEMANTIC_AUDIO_HUD_COPY: Record<Locale, Partial<Record<TranslationKey, string>>> = {
  tr: {
    audioMixer: 'SES MİKSERİ', masterVolume: 'Genel ses', musicVolume: 'Menü müziği',
    weaponVolume: 'Silah sesleri', effectsVolume: 'Efektler', musicOn: 'Müzik açık',
    musicOff: 'Müzik kapalı', flashlightOn: 'Flaş açık', flashlightOff: 'Flaş kapalı',
    flashlightUnsupported: 'Bu cihaz flaş ışığını desteklemiyor.', qrFreshTarget: 'QR hedefi doğrulandı',
    qrRetainedLock: 'Ağ hedef kilidi korunuyor', qrAutomaticTarget: 'Tek rakip otomatik seçildi',
    qrNoTarget: 'Ağ hedefi yok', qrClearTarget: 'Hedefi temizle',
    qrSwitchTarget: 'Hedef değiştirmek için başka QR okut', qrTargetHelp: 'Yeni QR hedefi tanımlar. QR kısa süre okunamazsa ağ kilidi hedef ayrılana veya temizlenene kadar korunur.',
  },
  en: { audioMixer: 'AUDIO MIXER', masterVolume: 'Master volume', musicVolume: 'Menu music', weaponVolume: 'Weapon sounds', effectsVolume: 'Effects', musicOn: 'Music on', musicOff: 'Music off', flashlightOn: 'Flashlight on', flashlightOff: 'Flashlight off', flashlightUnsupported: 'This device does not support the flashlight.', qrFreshTarget: 'QR target confirmed', qrRetainedLock: 'Network lock retained', qrAutomaticTarget: 'Sole opponent selected automatically', qrNoTarget: 'No network target', qrClearTarget: 'Clear target', qrSwitchTarget: 'Scan another QR to switch target', qrTargetHelp: 'A fresh QR scan identifies the target. If the QR is temporarily unreadable, the network lock remains until the target leaves or is cleared.' },
  zh: { audioMixer: '音频混音器', masterVolume: '主音量', musicVolume: '菜单音乐', weaponVolume: '武器音效', effectsVolume: '特效', musicOn: '音乐已开启', musicOff: '音乐已关闭', flashlightOn: '手电筒已开启', flashlightOff: '手电筒已关闭', flashlightUnsupported: '此设备不支持手电筒。', qrFreshTarget: 'QR 目标已确认', qrRetainedLock: '网络目标锁定已保留', qrAutomaticTarget: '已自动选择唯一对手', qrNoTarget: '没有网络目标', qrClearTarget: '清除目标', qrSwitchTarget: '扫描其他 QR 以切换目标', qrTargetHelp: '新的 QR 扫描会识别目标。QR 暂时无法读取时，网络锁定会持续到目标离开或被清除。' },
  ja: { audioMixer: 'オーディオミキサー', masterVolume: 'マスター音量', musicVolume: 'メニュー音楽', weaponVolume: '武器音', effectsVolume: '効果音', musicOn: '音楽オン', musicOff: '音楽オフ', flashlightOn: 'ライトオン', flashlightOff: 'ライトオフ', flashlightUnsupported: 'この端末はライトに対応していません。', qrFreshTarget: 'QRターゲット確認済み', qrRetainedLock: 'ネットワークロックを維持', qrAutomaticTarget: '唯一の相手を自動選択', qrNoTarget: 'ネットワークターゲットなし', qrClearTarget: 'ターゲットを解除', qrSwitchTarget: '別のQRを読み取って切り替え', qrTargetHelp: '新しいQRスキャンでターゲットを識別します。QRが一時的に読めなくても、相手が離れるか解除するまでネットワークロックは維持されます。' },
  ar: { audioMixer: 'خلاط الصوت', masterVolume: 'الصوت الرئيسي', musicVolume: 'موسيقى القائمة', weaponVolume: 'أصوات الأسلحة', effectsVolume: 'المؤثرات', musicOn: 'الموسيقى مفعلة', musicOff: 'الموسيقى متوقفة', flashlightOn: 'المصباح مفعّل', flashlightOff: 'المصباح متوقف', flashlightUnsupported: 'هذا الجهاز لا يدعم المصباح.', qrFreshTarget: 'تم تأكيد هدف QR', qrRetainedLock: 'تم الاحتفاظ بقفل الشبكة', qrAutomaticTarget: 'تم اختيار الخصم الوحيد تلقائياً', qrNoTarget: 'لا يوجد هدف شبكي', qrClearTarget: 'مسح الهدف', qrSwitchTarget: 'امسح QR آخر لتبديل الهدف', qrTargetHelp: 'يحدد مسح QR الجديد الهدف. إذا تعذر قراءة QR مؤقتاً، يستمر قفل الشبكة حتى يغادر الهدف أو يتم مسحه.' },
  de: { audioMixer: 'AUDIO-MIXER', masterVolume: 'Gesamtlautstärke', musicVolume: 'Menümusik', weaponVolume: 'Waffengeräusche', effectsVolume: 'Effekte', musicOn: 'Musik an', musicOff: 'Musik aus', flashlightOn: 'Taschenlampe an', flashlightOff: 'Taschenlampe aus', flashlightUnsupported: 'Dieses Gerät unterstützt keine Taschenlampe.', qrFreshTarget: 'QR-Ziel bestätigt', qrRetainedLock: 'Netzwerksperre beibehalten', qrAutomaticTarget: 'Einziger Gegner automatisch gewählt', qrNoTarget: 'Kein Netzwerkziel', qrClearTarget: 'Ziel löschen', qrSwitchTarget: 'Anderen QR scannen, um das Ziel zu wechseln', qrTargetHelp: 'Ein neuer QR-Scan erkennt das Ziel. Ist der QR kurz nicht lesbar, bleibt die Netzwerksperre bestehen, bis das Ziel geht oder gelöscht wird.' },
  fr: { audioMixer: 'MIXEUR AUDIO', masterVolume: 'Volume générale', musicVolume: 'Musique du menu', weaponVolume: 'Sons des armes', effectsVolume: 'Effets', musicOn: 'Musique activée', musicOff: 'Musique désactivée', flashlightOn: 'Lampe allumée', flashlightOff: 'Lampe éteinte', flashlightUnsupported: 'Cet appareil ne prend pas en charge la lampe.', qrFreshTarget: 'Cible QR confirmée', qrRetainedLock: 'Verrou réseau conservé', qrAutomaticTarget: 'Adversaire unique sélectionné automatiquement', qrNoTarget: 'Aucune cible réseau', qrClearTarget: 'Effacer la cible', qrSwitchTarget: 'Scannez un autre QR pour changer de cible', qrTargetHelp: 'Un nouveau scan QR identifie la cible. Si le QR est momentanément illisible, le verrou réseau reste actif jusqu’au départ ou à l’effacement de la cible.' },
  es: { audioMixer: 'MEZCLADOR DE AUDIO', masterVolume: 'Volumen principal', musicVolume: 'Música del menú', weaponVolume: 'Sonidos de armas', effectsVolume: 'Efectos', musicOn: 'Música activada', musicOff: 'Música desactivada', flashlightOn: 'Linterna encendida', flashlightOff: 'Linterna apagada', flashlightUnsupported: 'Este dispositivo no admite la linterna.', qrFreshTarget: 'Objetivo QR confirmado', qrRetainedLock: 'Bloqueo de red conservado', qrAutomaticTarget: 'Enemigo único seleccionado automáticamente', qrNoTarget: 'Sin objetivo de red', qrClearTarget: 'Borrar objetivo', qrSwitchTarget: 'Escanea otro QR para cambiar de objetivo', qrTargetHelp: 'Un nuevo escaneo QR identifica el objetivo. Si el QR no se puede leer temporalmente, el bloqueo de red continúa hasta que el objetivo se vaya o se borre.' },
  it: { audioMixer: 'MIXER AUDIO', masterVolume: 'Volume principale', musicVolume: 'Musica del menu', weaponVolume: 'Suoni delle armi', effectsVolume: 'Effetti', musicOn: 'Musica attiva', musicOff: 'Musica disattivata', flashlightOn: 'Torcia accesa', flashlightOff: 'Torcia spenta', flashlightUnsupported: 'Questo dispositivo non supporta la torcia.', qrFreshTarget: 'Bersaglio QR confermato', qrRetainedLock: 'Blocco di rete mantenuto', qrAutomaticTarget: 'Unico avversario selezionato automaticamente', qrNoTarget: 'Nessun bersaglio di rete', qrClearTarget: 'Cancella bersaglio', qrSwitchTarget: 'Scansiona un altro QR per cambiare bersaglio', qrTargetHelp: 'Una nuova scansione QR identifica il bersaglio. Se il QR è temporaneamente illeggibile, il blocco di rete resta fino all’uscita o alla rimozione del bersaglio.' },
  pt: { audioMixer: 'MIXADOR DE ÁUDIO', masterVolume: 'Volume principal', musicVolume: 'Música do menu', weaponVolume: 'Sons das armas', effectsVolume: 'Efeitos', musicOn: 'Música ligada', musicOff: 'Música desligada', flashlightOn: 'Lanterna ligada', flashlightOff: 'Lanterna desligada', flashlightUnsupported: 'Este dispositivo não suporta a lanterna.', qrFreshTarget: 'Alvo QR confirmado', qrRetainedLock: 'Bloqueio de rede mantido', qrAutomaticTarget: 'Único adversário selecionado automaticamente', qrNoTarget: 'Sem alvo de rede', qrClearTarget: 'Limpar alvo', qrSwitchTarget: 'Leia outro QR para trocar de alvo', qrTargetHelp: 'Uma nova leitura de QR identifica o alvo. Se o QR ficar temporariamente ilegível, o bloqueio de rede continua até o alvo sair ou ser removido.' },
  ru: { audioMixer: 'МИКШЕР ЗВУКА', masterVolume: 'Общая громкость', musicVolume: 'Музыка меню', weaponVolume: 'Звуки оружия', effectsVolume: 'Эффекты', musicOn: 'Музыка включена', musicOff: 'Музыка выключена', flashlightOn: 'Фонарик включён', flashlightOff: 'Фонарик выключен', flashlightUnsupported: 'Это устройство не поддерживает фонарик.', qrFreshTarget: 'Цель QR подтверждена', qrRetainedLock: 'Сетевой захват сохранён', qrAutomaticTarget: 'Единственный противник выбран автоматически', qrNoTarget: 'Нет сетевой цели', qrClearTarget: 'Сбросить цель', qrSwitchTarget: 'Сканируйте другой QR для смены цели', qrTargetHelp: 'Новый скан QR определяет цель. Если QR временно не читается, сетевой захват сохраняется, пока цель не уйдёт или не будет сброшена.' },
  uk: { audioMixer: 'МІКШЕР ЗВУКУ', masterVolume: 'Загальна гучність', musicVolume: 'Музика меню', weaponVolume: 'Звуки зброї', effectsVolume: 'Ефекти', musicOn: 'Музика ввімкнена', musicOff: 'Музика вимкнена', flashlightOn: 'Ліхтарик увімкнено', flashlightOff: 'Ліхтарик вимкнено', flashlightUnsupported: 'Цей пристрій не підтримує ліхтарик.', qrFreshTarget: 'Ціль QR підтверджено', qrRetainedLock: 'Мережеве захоплення збережено', qrAutomaticTarget: 'Єдиного супротивника вибрано автоматично', qrNoTarget: 'Немає мережевої цілі', qrClearTarget: 'Очистити ціль', qrSwitchTarget: 'Проскануйте інший QR, щоб змінити ціль', qrTargetHelp: 'Нове сканування QR визначає ціль. Якщо QR тимчасово не читається, мережеве захоплення триває, доки ціль не залишить гру або його не буде скинуто.' },
  hi: { audioMixer: 'ऑडियो मिक्सर', masterVolume: 'मुख्य वॉल्यूम', musicVolume: 'मेनू संगीत', weaponVolume: 'हथियार ध्वनियाँ', effectsVolume: 'प्रभाव', musicOn: 'संगीत चालू', musicOff: 'संगीत बंद', flashlightOn: 'फ्लैशलाइट चालू', flashlightOff: 'फ्लैशलाइट बंद', flashlightUnsupported: 'यह डिवाइस फ्लैशलाइट समर्थित नहीं करता।', qrFreshTarget: 'QR लक्ष्य की पुष्टि हुई', qrRetainedLock: 'नेटवर्क लॉक बना हुआ है', qrAutomaticTarget: 'एकमात्र प्रतिद्वंद्वी अपने-आप चुना गया', qrNoTarget: 'कोई नेटवर्क लक्ष्य नहीं', qrClearTarget: 'लक्ष्य हटाएँ', qrSwitchTarget: 'लक्ष्य बदलने के लिए दूसरा QR स्कैन करें', qrTargetHelp: 'नया QR स्कैन लक्ष्य पहचानता है। QR थोड़ी देर न पढ़े जाने पर भी लक्ष्य के जाने या हटाए जाने तक नेटवर्क लॉक बना रहता है।' },
  ur: { audioMixer: 'آڈیو مکسر', masterVolume: 'مرکزی آواز', musicVolume: 'مینو موسیقی', weaponVolume: 'ہتھیاروں کی آوازیں', effectsVolume: 'اثرات', musicOn: 'موسیقی آن', musicOff: 'موسیقی آف', flashlightOn: 'فلیش لائٹ آن', flashlightOff: 'فلیش لائٹ آف', flashlightUnsupported: 'یہ ڈیوائس فلیش لائٹ کو سپورٹ نہیں کرتی۔', qrFreshTarget: 'QR ہدف کی تصدیق ہوگئی', qrRetainedLock: 'نیٹ ورک لاک برقرار ہے', qrAutomaticTarget: 'واحد حریف خودکار طور پر منتخب ہوگیا', qrNoTarget: 'کوئی نیٹ ورک ہدف نہیں', qrClearTarget: 'ہدف صاف کریں', qrSwitchTarget: 'ہدف بدلنے کے لیے دوسرا QR اسکین کریں', qrTargetHelp: 'نیا QR اسکین ہدف کی شناخت کرتا ہے۔ QR عارضی طور پر نہ پڑھ سکے تو ہدف کے جانے یا صاف ہونے تک نیٹ ورک لاک برقرار رہتا ہے۔' },
  bn: { audioMixer: 'অডিও মিক্সার', masterVolume: 'মাস্টার ভলিউম', musicVolume: 'মেনু সঙ্গীত', weaponVolume: 'অস্ত্রের শব্দ', effectsVolume: 'প্রভাব', musicOn: 'সঙ্গীত চালু', musicOff: 'সঙ্গীত বন্ধ', flashlightOn: 'ফ্ল্যাশলাইট চালু', flashlightOff: 'ফ্ল্যাশলাইট বন্ধ', flashlightUnsupported: 'এই ডিভাইসে ফ্ল্যাশলাইট সমর্থিত নয়।', qrFreshTarget: 'QR লক্ষ্য নিশ্চিত', qrRetainedLock: 'নেটওয়ার্ক লক বজায় আছে', qrAutomaticTarget: 'একমাত্র প্রতিপক্ষ স্বয়ংক্রিয়ভাবে নির্বাচিত', qrNoTarget: 'কোনো নেটওয়ার্ক লক্ষ্য নেই', qrClearTarget: 'লক্ষ্য সরান', qrSwitchTarget: 'লক্ষ্য বদলাতে অন্য QR স্ক্যান করুন', qrTargetHelp: 'নতুন QR স্ক্যান লক্ষ্য শনাক্ত করে। QR সাময়িকভাবে পড়া না গেলেও লক্ষ্য চলে যাওয়া বা সরানো পর্যন্ত নেটওয়ার্ক লক থাকে।' },
  pa: { audioMixer: 'ਆਡੀਓ ਮਿਕਸਰ', masterVolume: 'ਮੁੱਖ ਆਵਾਜ਼', musicVolume: 'ਮੀਨੂ ਸੰਗੀਤ', weaponVolume: 'ਹਥਿਆਰਾਂ ਦੀਆਂ ਆਵਾਜ਼ਾਂ', effectsVolume: 'ਪ੍ਰਭਾਵ', musicOn: 'ਸੰਗੀਤ ਚਾਲੂ', musicOff: 'ਸੰਗੀਤ ਬੰਦ', flashlightOn: 'ਫਲੈਸ਼ਲਾਈਟ ਚਾਲੂ', flashlightOff: 'ਫਲੈਸ਼ਲਾਈਟ ਬੰਦ', flashlightUnsupported: 'ਇਹ ਡਿਵਾਈਸ ਫਲੈਸ਼ਲਾਈਟ ਨੂੰ ਸਹਿਯੋਗ ਨਹੀਂ ਦਿੰਦੀ।', qrFreshTarget: 'QR ਨਿਸ਼ਾਨਾ ਪੱਕਾ ਹੋਇਆ', qrRetainedLock: 'ਨੈੱਟਵਰਕ ਲੌਕ ਕਾਇਮ', qrAutomaticTarget: 'ਇਕੱਲਾ ਵਿਰੋਧੀ ਆਪਣੇ ਆਪ ਚੁਣਿਆ', qrNoTarget: 'ਕੋਈ ਨੈੱਟਵਰਕ ਨਿਸ਼ਾਨਾ ਨਹੀਂ', qrClearTarget: 'ਨਿਸ਼ਾਨਾ ਹਟਾਓ', qrSwitchTarget: 'ਨਿਸ਼ਾਨਾ ਬਦਲਣ ਲਈ ਹੋਰ QR ਸਕੈਨ ਕਰੋ', qrTargetHelp: 'ਨਵਾਂ QR ਸਕੈਨ ਨਿਸ਼ਾਨੇ ਦੀ ਪਛਾਣ ਕਰਦਾ ਹੈ। QR ਥੋੜ੍ਹੇ ਸਮੇਂ ਨਾ ਪੜ੍ਹੇ ਤਾਂ ਵੀ ਨਿਸ਼ਾਨਾ ਜਾਣ ਜਾਂ ਹਟਾਏ ਜਾਣ ਤੱਕ ਨੈੱਟਵਰਕ ਲੌਕ ਰਹਿੰਦਾ ਹੈ।' },
  id: { audioMixer: 'MIXER AUDIO', masterVolume: 'Volume utama', musicVolume: 'Musik menu', weaponVolume: 'Suara senjata', effectsVolume: 'Efek', musicOn: 'Musik aktif', musicOff: 'Musik nonaktif', flashlightOn: 'Senter aktif', flashlightOff: 'Senter nonaktif', flashlightUnsupported: 'Perangkat ini tidak mendukung senter.', qrFreshTarget: 'Target QR terkonfirmasi', qrRetainedLock: 'Kunci jaringan dipertahankan', qrAutomaticTarget: 'Satu-satunya lawan dipilih otomatis', qrNoTarget: 'Tidak ada target jaringan', qrClearTarget: 'Hapus target', qrSwitchTarget: 'Pindai QR lain untuk mengganti target', qrTargetHelp: 'Pindaian QR baru mengenali target. Jika QR sementara tidak terbaca, kunci jaringan tetap sampai target pergi atau dihapus.' },
  ko: { audioMixer: '오디오 믹서', masterVolume: '마스터 음량', musicVolume: '메뉴 음악', weaponVolume: '무기 소리', effectsVolume: '효과음', musicOn: '음악 켜짐', musicOff: '음악 꺼짐', flashlightOn: '손전등 켜짐', flashlightOff: '손전등 꺼짐', flashlightUnsupported: '이 기기는 손전등을 지원하지 않습니다.', qrFreshTarget: 'QR 대상 확인됨', qrRetainedLock: '네트워크 잠금 유지', qrAutomaticTarget: '유일한 상대를 자동 선택', qrNoTarget: '네트워크 대상 없음', qrClearTarget: '대상 지우기', qrSwitchTarget: '대상을 바꾸려면 다른 QR을 스캔하세요', qrTargetHelp: '새 QR 스캔이 대상을 식별합니다. QR을 잠시 읽지 못해도 대상이 나가거나 해제될 때까지 네트워크 잠금이 유지됩니다.' },
  vi: { audioMixer: 'BỘ TRỘN ÂM THANH', masterVolume: 'Âm lượng chính', musicVolume: 'Nhạc menu', weaponVolume: 'Âm thanh vũ khí', effectsVolume: 'Hiệu ứng', musicOn: 'Bật nhạc', musicOff: 'Tắt nhạc', flashlightOn: 'Bật đèn pin', flashlightOff: 'Tắt đèn pin', flashlightUnsupported: 'Thiết bị này không hỗ trợ đèn pin.', qrFreshTarget: 'Đã xác nhận mục tiêu QR', qrRetainedLock: 'Giữ khóa mạng', qrAutomaticTarget: 'Tự động chọn đối thủ duy nhất', qrNoTarget: 'Không có mục tiêu mạng', qrClearTarget: 'Xóa mục tiêu', qrSwitchTarget: 'Quét QR khác để đổi mục tiêu', qrTargetHelp: 'Lần quét QR mới xác định mục tiêu. Nếu QR tạm thời không đọc được, khóa mạng vẫn giữ đến khi mục tiêu rời đi hoặc bị xóa.' },
  th: { audioMixer: 'มิกเซอร์เสียง', masterVolume: 'เสียงหลัก', musicVolume: 'เพลงเมนู', weaponVolume: 'เสียงอาวุธ', effectsVolume: 'เอฟเฟกต์', musicOn: 'เปิดเพลง', musicOff: 'ปิดเพลง', flashlightOn: 'เปิดไฟฉาย', flashlightOff: 'ปิดไฟฉาย', flashlightUnsupported: 'อุปกรณ์นี้ไม่รองรับไฟฉาย', qrFreshTarget: 'ยืนยันเป้าหมาย QR แล้ว', qrRetainedLock: 'คงการล็อกเครือข่ายไว้', qrAutomaticTarget: 'เลือกคู่ต่อสู้เพียงคนเดียวอัตโนมัติ', qrNoTarget: 'ไม่มีเป้าหมายเครือข่าย', qrClearTarget: 'ล้างเป้าหมาย', qrSwitchTarget: 'สแกน QR อื่นเพื่อเปลี่ยนเป้าหมาย', qrTargetHelp: 'การสแกน QR ใหม่จะระบุเป้าหมาย หากอ่าน QR ไม่ได้ชั่วคราว การล็อกเครือข่ายจะคงอยู่จนกว่าเป้าหมายจะออกหรือถูกล้าง' },
  nl: { audioMixer: 'AUDIOMIXER', masterVolume: 'Hoofdvolume', musicVolume: 'Muziekmenu', weaponVolume: 'Wapengeluiden', effectsVolume: 'Effecten', musicOn: 'Muziek aan', musicOff: 'Muziek uit', flashlightOn: 'Zaklamp aan', flashlightOff: 'Zaklamp uit', flashlightUnsupported: 'Dit apparaat ondersteunt geen zaklamp.', qrFreshTarget: 'QR-doel bevestigd', qrRetainedLock: 'Netwerkvergrendeling behouden', qrAutomaticTarget: 'Enige tegenstander automatisch geselecteerd', qrNoTarget: 'Geen netwerkdoel', qrClearTarget: 'Doel wissen', qrSwitchTarget: 'Scan een andere QR om van doel te wisselen', qrTargetHelp: 'Een nieuwe QR-scan identificeert het doel. Als de QR tijdelijk niet leesbaar is, blijft de netwerkvergrendeling tot vertrek of wissen actief.' },
  pl: { audioMixer: 'MIKSER AUDIO', masterVolume: 'Głośność główna', musicVolume: 'Muzyka menu', weaponVolume: 'Dźwięki broni', effectsVolume: 'Efekty', musicOn: 'Muzyka włączona', musicOff: 'Muzyka wyłączona', flashlightOn: 'Latarka włączona', flashlightOff: 'Latarka wyłączona', flashlightUnsupported: 'To urządzenie nie obsługuje latarki.', qrFreshTarget: 'Cel QR potwierdzony', qrRetainedLock: 'Blokada sieci zachowana', qrAutomaticTarget: 'Jedyny przeciwnik wybrany automatycznie', qrNoTarget: 'Brak celu sieciowego', qrClearTarget: 'Wyczyść cel', qrSwitchTarget: 'Zeskanuj inny QR, aby zmienić cel', qrTargetHelp: 'Nowy skan QR rozpoznaje cel. Jeśli QR chwilowo nie można odczytać, blokada sieci trwa do odejścia lub wyczyszczenia celu.' },
  sv: { audioMixer: 'LJUDMIXER', masterVolume: 'Huvudvolym', musicVolume: 'Meny musik', weaponVolume: 'Vapenljud', effectsVolume: 'Effekter', musicOn: 'Musik på', musicOff: 'Musik av', flashlightOn: 'Ficklampa på', flashlightOff: 'Ficklampa av', flashlightUnsupported: 'Den här enheten stöder inte ficklampa.', qrFreshTarget: 'QR-mål bekräftat', qrRetainedLock: 'Nätverkslås behålls', qrAutomaticTarget: 'Enda motståndaren valdes automatiskt', qrNoTarget: 'Inget nätverksmål', qrClearTarget: 'Rensa mål', qrSwitchTarget: 'Skanna en annan QR för att byta mål', qrTargetHelp: 'En ny QR-skanning identifierar målet. Om QR tillfälligt inte kan läsas behålls nätverkslåset tills målet lämnar eller rensas.' },
  fa: { audioMixer: 'میکسر صدا', masterVolume: 'صدای اصلی', musicVolume: 'موسیقی منو', weaponVolume: 'صدای سلاح', effectsVolume: 'جلوه‌ها', musicOn: 'موسیقی روشن', musicOff: 'موسیقی خاموش', flashlightOn: 'چراغ‌قوه روشن', flashlightOff: 'چراغ‌قوه خاموش', flashlightUnsupported: 'این دستگاه از چراغ‌قوه پشتیبانی نمی‌کند.', qrFreshTarget: 'هدف QR تأیید شد', qrRetainedLock: 'قفل شبکه حفظ شد', qrAutomaticTarget: 'تنها حریف به‌صورت خودکار انتخاب شد', qrNoTarget: 'هدف شبکه‌ای وجود ندارد', qrClearTarget: 'پاک‌کردن هدف', qrSwitchTarget: 'برای تغییر هدف QR دیگری را اسکن کنید', qrTargetHelp: 'اسکن تازه QR هدف را شناسایی می‌کند. اگر QR موقتاً خوانده نشود، قفل شبکه تا خروج یا پاک‌شدن هدف باقی می‌ماند.' },
};

for (const locale of SUPPORTED_LOCALES) {
  Object.assign(TRANSLATIONS[locale], SEMANTIC_AUDIO_HUD_COPY[locale]);
}
...
export type LobbyCopyKey =
  | 'battleConsent' | 'consentRequired' | 'cameraPermissionRequest'
  | 'cameraPermissionOpenSettings' | 'assignedPlayer' | 'stickerInstructions'
  | 'designRange' | 'hitTolerance' | 'networkContinuity'
  | 'matchJoinQr' | 'scanJoinQr' | 'manualCodeFallback'
  | 'targetPdf' | 'viewPdf' | 'printPdf' | 'sharePdf'
  | 'sharingUnavailable' | 'sharingFailed' | 'printingFailed'
  | 'scanJoinQrHint' | 'invalidJoinQr'
  | 'tutorialTitle' | 'tutorialStep1' | 'tutorialStep2' | 'tutorialStep3'
  | 'tutorialStep4' | 'tutorialCameraWarning' | 'tutorialSkip'
  | 'tutorialNext' | 'tutorialBack' | 'tutorialDone' | 'howToPrepare';
...
type UiCopy = Record<Exclude<UiCopyKey, PermissionUiCopyKey | LobbyCopyKey>, string>;

const LOBBY_COPY_EN: Partial<Record<LobbyCopyKey, string>> = {
  battleConsent: 'I agree that the server synchronizes room, player and combat state. The camera reads Red Zone QR tags on this device; camera frames are not uploaded.',
  consentRequired: 'Consent is required before joining a multiplayer room.',
  cameraPermissionRequest: 'Camera access is needed to read Red Zone tags and match QR codes.',
  cameraPermissionOpenSettings: 'Camera access is blocked. Open settings to allow it.',
  assignedPlayer: 'Assigned player',
  stickerInstructions: 'Attach your permanent player sticker visibly to the back of your phone. Keep it readable for other players.',
  designRange: 'Design range: up to 5 m. Real-device validation is still required.',
  hitTolerance: 'The reticle allows approximately 30 cm of error in every direction; exact center is not required.',
  networkContinuity: 'A fresh QR selects a network target. If the QR is temporarily unreadable, the network lock continues. With one live opponent, that player is selected automatically.',
  matchJoinQr: 'Match join QR',
  scanJoinQr: 'Scan match QR',
  manualCodeFallback: 'Or enter the room code manually.',
  targetPdf: 'Player target PDF',
  viewPdf: 'View PDF',
  printPdf: 'Print',
  sharePdf: 'Share',
  sharingUnavailable: 'Sharing is unavailable on this device.',
  sharingFailed: 'The PDF could not be shared.',
  printingFailed: 'The PDF could not be printed.',
  scanJoinQrHint: 'Point the camera at the host match QR. No session token is stored in the code.',
  invalidJoinQr: 'This is not a valid Red Zone match QR.',
};

const LOBBY_COPY_TR: Partial<Record<LobbyCopyKey, string>> = {
  battleConsent: 'Oda, oyuncu ve savaş durumunun sunucu tarafından eşitlenmesini kabul ediyorum. Kamera Red Zone QR hedeflerini bu cihazda okur; kamera görüntüleri yüklenmez.',
  consentRequired: 'Çok oyunculu odaya girmeden önce onay gereklidir.',
  cameraPermissionRequest: 'Red Zone hedeflerini ve maç QR kodlarını okumak için kamera izni gerekir.',
  cameraPermissionOpenSettings: 'Kamera izni kapalı. Açmak için ayarları açın.',
  assignedPlayer: 'Atanan oyuncu',
  stickerInstructions: 'Kalıcı oyuncu etiketinizi telefonunuzun arkasına görünür biçimde yapıştırın. Diğer oyuncular okuyabilsin.',
  designRange: 'Tasarım mesafesi en fazla 5 m’dir. Gerçek cihaz doğrulaması gereklidir.',
  hitTolerance: 'Nişangâh her yönde yaklaşık 30 cm hataya izin verir; tam merkez şart değildir.',
  networkContinuity: 'Yeni QR ağ hedefini seçer. QR geçici olarak okunamazsa ağ kilidi sürer. Tek canlı rakip varsa otomatik seçilir.',
  matchJoinQr: 'Maç katılım QR’ı',
  scanJoinQr: 'Maç QR’ını okut',
  manualCodeFallback: 'Ya da oda kodunu elle girin.',
  targetPdf: 'Oyuncu hedef PDF’i',
  viewPdf: 'PDF’yi görüntüle',
  printPdf: 'Yazdır',
  sharePdf: 'Paylaş',
  sharingUnavailable: 'Bu cihazda paylaşım kullanılamıyor.',
  sharingFailed: 'PDF paylaşılamadı.',
  printingFailed: 'PDF yazdırılamadı.',
  scanJoinQrHint: 'Kamerayı sunucunun maç QR’ına tutun. Kodda oturum anahtarı bulunmaz.',
  invalidJoinQr: 'Bu geçerli bir Red Zone maç QR’ı değil.',
};

const LOBBY_COPY_LOCALIZED: Record<Locale, Partial<Record<LobbyCopyKey, string>>> = {
  tr: LOBBY_COPY_TR,
  en: LOBBY_COPY_EN,
  zh: {
    battleConsent: '我同意服务器同步房间、玩家和战斗状态。相机在本设备读取 Red Zone QR 目标；相机画面不会上传。',
    consentRequired: '加入多人房间前必须同意。',
    cameraPermissionRequest: '读取 Red Zone 目标和比赛 QR 码需要相机权限。',
    cameraPermissionOpenSettings: '相机权限已被阻止。请打开设置允许使用相机。',
    assignedPlayer: '分配的玩家', stickerInstructions: '将你的永久玩家贴纸清晰地贴在手机背面，方便其他玩家读取。',
    designRange: '设计距离：最远 5 米。仍需在真实设备上验证。', hitTolerance: '瞄准点允许各方向约 30 厘米误差；无需正中。',
    networkContinuity: '新的 QR 会选择网络目标。QR 暂时无法读取时，网络锁定会继续。只有一名存活对手时会自动选择。',
    matchJoinQr: '比赛加入 QR', scanJoinQr: '扫描比赛 QR', manualCodeFallback: '或手动输入房间代码。',
    targetPdf: '玩家目标 PDF', viewPdf: '查看 PDF', printPdf: '打印', sharePdf: '分享',
    sharingUnavailable: '此设备无法分享。', sharingFailed: '无法分享 PDF。', printingFailed: '无法打印 PDF。',
    scanJoinQrHint: '将相机对准房主的比赛 QR。代码中不含会话令牌。', invalidJoinQr: '这不是有效的 Red Zone 比赛 QR。',
  },
  ja: {
    battleConsent: 'サーバーがルーム、プレイヤー、戦闘状態を同期することに同意します。カメラはこの端末で Red Zone QR を読み取り、映像はアップロードされません。',
    consentRequired: 'マルチプレイヤールームへの参加には同意が必要です。',
    cameraPermissionRequest: 'Red Zone タグと試合 QR の読み取りにカメラの許可が必要です。',
    cameraPermissionOpenSettings: 'カメラの許可がブロックされています。設定で許可してください。',
    assignedPlayer: '割り当てプレイヤー', stickerInstructions: '恒久プレイヤーステッカーをスマホの背面に見えるよう貼り、他のプレイヤーが読めるようにしてください。',
    designRange: '設計距離：最大 5 m。実機での確認が必要です。', hitTolerance: '照準は全方向約 30 cm の誤差を許容します。中心ぴったりは不要です。',
    networkContinuity: '新しい QR がネットワーク対象を選びます。QR が一時的に読めなくてもロックは継続します。生存相手が1人なら自動選択します。',
    matchJoinQr: '試合参加 QR', scanJoinQr: '試合 QR をスキャン', manualCodeFallback: 'またはルームコードを入力。',
    targetPdf: 'プレイヤーターゲット PDF', viewPdf: 'PDF を表示', printPdf: '印刷', sharePdf: '共有',
    sharingUnavailable: 'この端末では共有できません。', sharingFailed: 'PDF を共有できませんでした。', printingFailed: 'PDF を印刷できませんでした。',
    scanJoinQrHint: 'ホストの試合 QR にカメラを向けてください。コードにセッションキーは含まれません。', invalidJoinQr: '有効な Red Zone 試合 QR ではありません。',
  },
  ar: {
    battleConsent: 'أوافق على مزامنة الخادم لحالة الغرفة واللاعبين والقتال. تقرأ الكاميرا أهداف Red Zone QR على هذا الجهاز ولا تُرفع الصور.',
    consentRequired: 'يلزم الموافقة قبل الانضمام إلى غرفة متعددة اللاعبين.',
    cameraPermissionRequest: 'يلزم إذن الكاميرا لقراءة أهداف Red Zone ورموز QR للمباراة.',
    cameraPermissionOpenSettings: 'تم حظر إذن الكاميرا. افتح الإعدادات للسماح به.',
    assignedPlayer: 'اللاعب المعيّن', stickerInstructions: 'ألصق ملصق اللاعب الدائم بوضوح على ظهر هاتفك ليقرأه اللاعبون الآخرون.',
    designRange: 'مسافة التصميم: حتى 5 م. ما زال التحقق بجهاز حقيقي مطلوباً.', hitTolerance: 'يسمح التصويب بخطأ يقارب 30 سم في كل اتجاه؛ لا يلزم المركز تماماً.',
    networkContinuity: 'يحدد QR جديد هدف الشبكة. إذا تعذر قراءة QR مؤقتاً يستمر القفل. عند وجود خصم حي واحد يُختار تلقائياً.',
    matchJoinQr: 'QR الانضمام للمباراة', scanJoinQr: 'مسح QR المباراة', manualCodeFallback: 'أو أدخل رمز الغرفة يدوياً.',
    targetPdf: 'ملف أهداف اللاعبين PDF', viewPdf: 'عرض PDF', printPdf: 'طباعة', sharePdf: 'مشاركة',
    sharingUnavailable: 'المشاركة غير متاحة على هذا الجهاز.', sharingFailed: 'تعذرت مشاركة PDF.', printingFailed: 'تعذرت طباعة PDF.',
    scanJoinQrHint: 'وجّه الكاميرا إلى QR المباراة لدى المضيف. لا يحتوي الرمز على مفتاح جلسة.', invalidJoinQr: 'هذا ليس QR صالحاً لمباراة Red Zone.',
  },
  de: {
    battleConsent: 'Ich stimme zu, dass der Server Raum-, Spieler- und Kampfstatus synchronisiert. Die Kamera liest Red-Zone-QRs auf diesem Gerät; Kamerabilder werden nicht hochgeladen.',
    consentRequired: 'Vor dem Beitritt zu einem Mehrspielerraum ist eine Zustimmung erforderlich.',
    cameraPermissionRequest: 'Für Red-Zone-Ziele und Spiel-QRs wird Kamerazugriff benötigt.',
    cameraPermissionOpenSettings: 'Kamerazugriff ist blockiert. Erlaube ihn in den Einstellungen.',
    assignedPlayer: 'Zugewiesener Spieler', stickerInstructions: 'Befestige deinen dauerhaften Spielersticker sichtbar auf der Rückseite des Telefons, damit andere ihn lesen können.',
    designRange: 'Entwurfsreichweite: bis 5 m. Prüfung mit echten Geräten steht noch aus.', hitTolerance: 'Das Fadenkreuz erlaubt etwa 30 cm Abweichung in jede Richtung; die Mitte ist nicht erforderlich.',
    networkContinuity: 'Ein neuer QR wählt das Netzwerkziel. Ist der QR kurz nicht lesbar, bleibt die Sperre bestehen. Bei einem einzigen lebenden Gegner wird dieser automatisch gewählt.',
    matchJoinQr: 'Beitritts-QR des Spiels', scanJoinQr: 'Spiel-QR scannen', manualCodeFallback: 'Oder Raumcode manuell eingeben.',
    targetPdf: 'Spielerziel-PDF', viewPdf: 'PDF anzeigen', printPdf: 'Drucken', sharePdf: 'Teilen',
    sharingUnavailable: 'Teilen ist auf diesem Gerät nicht verfügbar.', sharingFailed: 'Das PDF konnte nicht geteilt werden.', printingFailed: 'Das PDF konnte nicht gedruckt werden.',
    scanJoinQrHint: 'Richte die Kamera auf den Spiel-QR des Hosts. Der Code enthält kein Sitzungstoken.', invalidJoinQr: 'Das ist kein gültiger Red-Zone-Spiel-QR.',
  },
  fr: {
    battleConsent: 'J’accepte que le serveur synchronise l’état de la salle, des joueurs et du combat. La caméra lit les QR Red Zone sur cet appareil ; les images ne sont pas envoyées.',
    consentRequired: 'Votre accord est requis avant de rejoindre une salle multijoueur.',
    cameraPermissionRequest: 'L’accès à la caméra est nécessaire pour lire les cibles Red Zone et les QR de partie.',
    cameraPermissionOpenSettings: 'L’accès caméra est bloqué. Autorisez-le dans les réglages.',
    assignedPlayer: 'Joueur attribué', stickerInstructions: 'Fixez votre autocollant permanent au dos du téléphone, bien visible pour les autres joueurs.',
    designRange: 'Portée de conception : jusqu’à 5 m. Une validation sur appareil réel reste nécessaire.', hitTolerance: 'Le viseur tolère environ 30 cm d’erreur dans chaque direction ; le centre exact n’est pas requis.',
    networkContinuity: 'Un nouveau QR sélectionne la cible réseau. S’il est momentanément illisible, le verrou reste actif. Avec un seul adversaire vivant, il est sélectionné automatiquement.',
    matchJoinQr: 'QR de rejoindre la partie', scanJoinQr: 'Scanner le QR de la partie', manualCodeFallback: 'Ou saisir le code de salle manuellement.',
    targetPdf: 'PDF des cibles joueurs', viewPdf: 'Voir le PDF', printPdf: 'Imprimer', sharePdf: 'Partager',
    sharingUnavailable: 'Le partage est indisponible sur cet appareil.', sharingFailed: 'Impossible de partager le PDF.', printingFailed: 'Impossible d’imprimer le PDF.',
    scanJoinQrHint: 'Pointez la caméra vers le QR de partie de l’hôte. Le code ne contient aucun jeton de session.', invalidJoinQr: 'Ce QR n’est pas un QR de partie Red Zone valide.',
  },
  es: {
    battleConsent: 'Acepto que el servidor sincronice el estado de la sala, los jugadores y el combate. La cámara lee los QR de Red Zone en este dispositivo; las imágenes no se suben.',
    consentRequired: 'Debes aceptar antes de unirte a una sala multijugador.',
    cameraPermissionRequest: 'Se necesita acceso a la cámara para leer objetivos Red Zone y QR de partida.',
    cameraPermissionOpenSettings: 'El acceso a la cámara está bloqueado. Permítelo en Ajustes.',
    assignedPlayer: 'Jugador asignado', stickerInstructions: 'Coloca la pegatina permanente del jugador visible en la parte trasera del teléfono para que otros la lean.',
    designRange: 'Alcance de diseño: hasta 5 m. Aún se requiere validación con dispositivos reales.', hitTolerance: 'La mira permite unos 30 cm de error en cada dirección; no hace falta apuntar al centro exacto.',
    networkContinuity: 'Un nuevo QR selecciona el objetivo de red. Si el QR no se puede leer temporalmente, el bloqueo continúa. Con un único rival vivo, se selecciona automáticamente.',
    matchJoinQr: 'QR para unirse a la partida', scanJoinQr: 'Escanear QR de partida', manualCodeFallback: 'O introduce el código de sala manualmente.',
    targetPdf: 'PDF de objetivos de jugadores', viewPdf: 'Ver PDF', printPdf: 'Imprimir', sharePdf: 'Compartir',
    sharingUnavailable: 'No se puede compartir en este dispositivo.', sharingFailed: 'No se pudo compartir el PDF.', printingFailed: 'No se pudo imprimir el PDF.',
    scanJoinQrHint: 'Apunta la cámara al QR de partida del anfitrión. El código no contiene ningún token de sesión.', invalidJoinQr: 'Este no es un QR de partida Red Zone válido.',
  },
  it: {
    battleConsent: 'Accetto che il server sincronizzi lo stato della stanza, dei giocatori e della battaglia. La fotocamera legge i QR Red Zone sul dispositivo; le immagini non vengono caricate.',
    consentRequired: 'È necessario accettare prima di entrare in una stanza multiplayer.',
    cameraPermissionRequest: 'Serve l’accesso alla fotocamera per leggere i bersagli Red Zone e i QR della partita.',
    cameraPermissionOpenSettings: 'L’accesso alla fotocamera è bloccato. Abilitalo nelle impostazioni.',
    assignedPlayer: 'Giocatore assegnato', stickerInstructions: 'Applica l’adesivo permanente del giocatore sul retro del telefono, ben visibile agli altri.',
    designRange: 'Distanza di progetto: fino a 5 m. Serve ancora una verifica su dispositivi reali.', hitTolerance: 'Il mirino tollera circa 30 cm di errore in ogni direzione; non serve il centro esatto.',
    networkContinuity: 'Un nuovo QR seleziona il bersaglio di rete. Se il QR è temporaneamente illeggibile, il blocco continua. Con un solo avversario vivo, viene scelto automaticamente.',
    matchJoinQr: 'QR per entrare nella partita', scanJoinQr: 'Scansiona QR partita', manualCodeFallback: 'Oppure inserisci manualmente il codice stanza.',
    targetPdf: 'PDF bersagli giocatori', viewPdf: 'Visualizza PDF', printPdf: 'Stampa', sharePdf: 'Condividi',
    sharingUnavailable: 'La condivisione non è disponibile su questo dispositivo.', sharingFailed: 'Impossibile condividere il PDF.', printingFailed: 'Impossibile stampare il PDF.',
    scanJoinQrHint: 'Inquadra il QR partita dell’host. Il codice non contiene token di sessione.', invalidJoinQr: 'Questo non è un QR partita Red Zone valido.',
  },
  pt: {
    battleConsent: 'Aceito que o servidor sincronize o estado da sala, dos jogadores e do combate. A câmara lê QR da Red Zone neste dispositivo; as imagens não são enviadas.',
    consentRequired: 'É necessário consentir antes de entrar numa sala multijogador.',
    cameraPermissionRequest: 'É necessário acesso à câmara para ler alvos Red Zone e QR da partida.',
    cameraPermissionOpenSettings: 'O acesso à câmara está bloqueado. Permita-o nas definições.',
    assignedPlayer: 'Jogador atribuído', stickerInstructions: 'Cole o autocolante permanente do jogador visivelmente na parte de trás do telefone para os outros o lerem.',
    designRange: 'Alcance de projeto: até 5 m. Ainda é necessária validação em dispositivos reais.', hitTolerance: 'A mira permite cerca de 30 cm de erro em cada direção; não é necessário o centro exato.',
    networkContinuity: 'Um novo QR seleciona o alvo de rede. Se o QR ficar temporariamente ilegível, o bloqueio continua. Com um único adversário vivo, é selecionado automaticamente.',
    matchJoinQr: 'QR para entrar na partida', scanJoinQr: 'Ler QR da partida', manualCodeFallback: 'Ou introduza o código da sala manualmente.',
    targetPdf: 'PDF de alvos dos jogadores', viewPdf: 'Ver PDF', printPdf: 'Imprimir', sharePdf: 'Partilhar',
    sharingUnavailable: 'A partilha não está disponível neste dispositivo.', sharingFailed: 'Não foi possível partilhar o PDF.', printingFailed: 'Não foi possível imprimir o PDF.',
    scanJoinQrHint: 'Aponte a câmara para o QR da partida do anfitrião. O código não contém token de sessão.', invalidJoinQr: 'Este não é um QR de partida Red Zone válido.',
  },
  ru: {
    battleConsent: 'Я согласен, что сервер синхронизирует состояние комнаты, игроков и боя. Камера читает QR-метки Red Zone на этом устройстве; кадры не загружаются.',
    consentRequired: 'Перед входом в многопользовательскую комнату нужно согласие.',
    cameraPermissionRequest: 'Для чтения целей Red Zone и QR-кодов матча нужен доступ к камере.',
    cameraPermissionOpenSettings: 'Доступ к камере заблокирован. Разрешите его в настройках.',
    assignedPlayer: 'Назначенный игрок', stickerInstructions: 'Закрепите постоянную метку игрока на видимой задней стороне телефона, чтобы другие могли её прочитать.',
    designRange: 'Расчётная дальность: до 5 м. Требуется проверка на реальных устройствах.', hitTolerance: 'Прицел допускает около 30 см ошибки в каждом направлении; точный центр не нужен.',
    networkContinuity: 'Новый QR выбирает сетевую цель. Если QR временно не читается, захват сохраняется. При одном живом противнике он выбирается автоматически.',
    matchJoinQr: 'QR для входа в матч', scanJoinQr: 'Сканировать QR матча', manualCodeFallback: 'Или введите код комнаты вручную.',
    targetPdf: 'PDF целей игроков', viewPdf: 'Открыть PDF', printPdf: 'Печать', sharePdf: 'Поделиться',
    sharingUnavailable: 'На этом устройстве нельзя поделиться.', sharingFailed: 'Не удалось поделиться PDF.', printingFailed: 'Не удалось напечатать PDF.',
    scanJoinQrHint: 'Наведите камеру на QR матча у ведущего. Код не содержит ключ сессии.', invalidJoinQr: 'Это недействительный QR матча Red Zone.',
  },
  uk: {
    battleConsent: 'Я погоджуюся, що сервер синхронізує стан кімнати, гравців і бою. Камера читає QR-мітки Red Zone на цьому пристрої; кадри не завантажуються.',
    consentRequired: 'Перед входом до багатокористувацької кімнати потрібна згода.',
    cameraPermissionRequest: 'Для читання цілей Red Zone і QR-кодів матчу потрібен доступ до камери.',
    cameraPermissionOpenSettings: 'Доступ до камери заблоковано. Дозвольте його в налаштуваннях.',
    assignedPlayer: 'Призначений гравець', stickerInstructions: 'Прикріпіть постійну мітку гравця на видимій задній частині телефона, щоб інші могли її прочитати.',
    designRange: 'Розрахункова дальність: до 5 м. Потрібна перевірка на реальних пристроях.', hitTolerance: 'Приціл допускає приблизно 30 см похибки в кожному напрямку; точний центр не потрібен.',
    networkContinuity: 'Нове QR обирає мережеву ціль. Якщо QR тимчасово не читається, захоплення триває. За одного живого супротивника його буде обрано автоматично.',
    matchJoinQr: 'QR для входу в матч', scanJoinQr: 'Сканувати QR матчу', manualCodeFallback: 'Або введіть код кімнати вручну.',
    targetPdf: 'PDF цілей гравців', viewPdf: 'Переглянути PDF', printPdf: 'Друк', sharePdf: 'Поділитися',
    sharingUnavailable: 'На цьому пристрої не можна ділитися.', sharingFailed: 'Не вдалося поділитися PDF.', printingFailed: 'Не вдалося надрукувати PDF.',
    scanJoinQrHint: 'Наведіть камеру на QR матчу ведучого. Код не містить ключа сеансу.', invalidJoinQr: 'Це недійсний QR матчу Red Zone.',
  },
  hi: {
    battleConsent: 'मैं सहमत हूँ कि सर्वर कमरे, खिलाड़ी और मुकाबले की स्थिति सिंक करे। कैमरा इसी डिवाइस पर Red Zone QR पढ़ता है; कैमरा फ़्रेम अपलोड नहीं होते।',
    consentRequired: 'मल्टीप्लेयर कमरे में शामिल होने से पहले सहमति ज़रूरी है।',
    cameraPermissionRequest: 'Red Zone लक्ष्य और मैच QR पढ़ने के लिए कैमरा अनुमति चाहिए।',
    cameraPermissionOpenSettings: 'कैमरा अनुमति अवरुद्ध है। सेटिंग में इसे अनुमति दें।',
    assignedPlayer: 'निर्धारित खिलाड़ी', stickerInstructions: 'अपना स्थायी खिलाड़ी स्टिकर फ़ोन के पीछे साफ़ दिखाई देने वाली जगह लगाएँ, ताकि दूसरे खिलाड़ी पढ़ सकें।',
    designRange: 'डिज़ाइन दूरी: अधिकतम 5 मीटर। वास्तविक डिवाइस पर जाँच अभी आवश्यक है।', hitTolerance: 'निशाना हर दिशा में लगभग 30 सेमी की त्रुटि स्वीकार करता है; ठीक केंद्र ज़रूरी नहीं।',
    networkContinuity: 'नया QR नेटवर्क लक्ष्य चुनता है। QR कुछ समय न पढ़े तो लॉक जारी रहता है। केवल एक जीवित प्रतिद्वंद्वी हो तो वह अपने-आप चुना जाता है।',
    matchJoinQr: 'मैच में शामिल होने का QR', scanJoinQr: 'मैच QR स्कैन करें', manualCodeFallback: 'या कमरे का कोड हाथ से दर्ज करें।',
    targetPdf: 'खिलाड़ी लक्ष्य PDF', viewPdf: 'PDF देखें', printPdf: 'प्रिंट', sharePdf: 'साझा करें',
    sharingUnavailable: 'इस डिवाइस पर साझा करना उपलब्ध नहीं है।', sharingFailed: 'PDF साझा नहीं किया जा सका।', printingFailed: 'PDF प्रिंट नहीं किया जा सका।',
    scanJoinQrHint: 'होस्ट के मैच QR पर कैमरा करें। कोड में सत्र टोकन नहीं है।', invalidJoinQr: 'यह मान्य Red Zone मैच QR नहीं है।',
  },
  ur: {
    battleConsent: 'میں اتفاق کرتا ہوں کہ سرور کمرے، کھلاڑی اور جنگ کی حالت ہم وقت کرے۔ کیمرا اسی ڈیوائس پر Red Zone QR پڑھتا ہے؛ کیمرے کے فریم اپ لوڈ نہیں ہوتے۔',
    consentRequired: 'ملٹی پلیئر کمرے میں شامل ہونے سے پہلے رضامندی ضروری ہے۔',
    cameraPermissionRequest: 'Red Zone اہداف اور میچ QR پڑھنے کے لیے کیمرے کی اجازت درکار ہے۔',
    cameraPermissionOpenSettings: 'کیمرے کی اجازت مسدود ہے۔ ترتیبات میں اجازت دیں۔',
    assignedPlayer: 'مقررہ کھلاڑی', stickerInstructions: 'اپنا مستقل کھلاڑی اسٹیکر فون کے پچھلے حصے پر نمایاں طور پر لگائیں تاکہ دوسرے اسے پڑھ سکیں۔',
    designRange: 'ڈیزائن فاصلہ: 5 میٹر تک۔ حقیقی ڈیوائس پر جانچ ابھی ضروری ہے۔', hitTolerance: 'نشانہ ہر سمت تقریباً 30 سینٹی میٹر کی غلطی برداشت کرتا ہے؛ عین مرکز ضروری نہیں۔',
    networkContinuity: 'نیا QR نیٹ ورک ہدف منتخب کرتا ہے۔ QR عارضی طور پر نہ پڑھے تو لاک جاری رہتا ہے۔ ایک زندہ حریف ہو تو وہ خود منتخب ہوتا ہے۔',
    matchJoinQr: 'میچ میں شامل ہونے کا QR', scanJoinQr: 'میچ QR اسکین کریں', manualCodeFallback: 'یا کمرے کا کوڈ دستی طور پر درج کریں۔',
    targetPdf: 'کھلاڑی ہدف PDF', viewPdf: 'PDF دیکھیں', printPdf: 'پرنٹ', sharePdf: 'شیئر کریں',
    sharingUnavailable: 'اس ڈیوائس پر شیئرنگ دستیاب نہیں۔', sharingFailed: 'PDF شیئر نہیں ہو سکی۔', printingFailed: 'PDF پرنٹ نہیں ہو سکی۔',
    scanJoinQrHint: 'میزبان کے میچ QR پر کیمرا رکھیں۔ کوڈ میں سیشن ٹوکن نہیں ہے۔', invalidJoinQr: 'یہ درست Red Zone میچ QR نہیں ہے۔',
  },
  bn: {
    battleConsent: 'আমি সম্মত যে সার্ভার রুম, খেলোয়াড় ও যুদ্ধের অবস্থা সিঙ্ক করবে। ক্যামেরা এই ডিভাইসে Red Zone QR পড়ে; ক্যামেরার ফ্রেম আপলোড হয় না।',
    consentRequired: 'মাল্টিপ্লেয়ার রুমে যোগ দেওয়ার আগে সম্মতি প্রয়োজন।',
    cameraPermissionRequest: 'Red Zone লক্ষ্য ও ম্যাচ QR পড়তে ক্যামেরা অনুমতি দরকার।',
    cameraPermissionOpenSettings: 'ক্যামেরা অনুমতি বন্ধ আছে। সেটিংসে অনুমতি দিন।',
    assignedPlayer: 'নির্ধারিত খেলোয়াড়', stickerInstructions: 'স্থায়ী খেলোয়াড় স্টিকার ফোনের পেছনে স্পষ্টভাবে লাগান, যাতে অন্যরা পড়তে পারে।',
    designRange: 'নকশা দূরত্ব: সর্বোচ্চ ৫ মিটার। বাস্তব ডিভাইসে যাচাই এখনও দরকার।', hitTolerance: 'নিশানা প্রতিটি দিকে প্রায় ৩০ সেমি ভুল সহ্য করে; একেবারে কেন্দ্রে হওয়া জরুরি নয়।',
    networkContinuity: 'নতুন QR নেটওয়ার্ক লক্ষ্য বেছে নেয়। QR সাময়িকভাবে পড়া না গেলেও লক থাকে। এক জীবিত প্রতিপক্ষ থাকলে তাকে স্বয়ংক্রিয়ভাবে বেছে নেওয়া হয়।',
    matchJoinQr: 'ম্যাচে যোগদানের QR', scanJoinQr: 'ম্যাচ QR স্ক্যান করুন', manualCodeFallback: 'অথবা রুম কোড হাতে লিখুন।',
    targetPdf: 'খেলোয়াড় লক্ষ্য PDF', viewPdf: 'PDF দেখুন', printPdf: 'প্রিন্ট', sharePdf: 'শেয়ার',
    sharingUnavailable: 'এই ডিভাইসে শেয়ার করা যায় না।', sharingFailed: 'PDF শেয়ার করা যায়নি।', printingFailed: 'PDF প্রিন্ট করা যায়নি।',
    scanJoinQrHint: 'হোস্টের ম্যাচ QR-এর দিকে ক্যামেরা ধরুন। কোডে কোনো সেশন টোকেন নেই।', invalidJoinQr: 'এটি বৈধ Red Zone ম্যাচ QR নয়।',
  },
  pa: {
    battleConsent: 'ਮੈਂ ਸਹਿਮਤ ਹਾਂ ਕਿ ਸਰਵਰ ਕਮਰੇ, ਖਿਡਾਰੀ ਅਤੇ ਲੜਾਈ ਦੀ ਸਥਿਤੀ ਸਿੰਕ ਕਰੇ। ਕੈਮਰਾ ਇਸ ਡਿਵਾਈਸ ’ਤੇ Red Zone QR ਪੜ੍ਹਦਾ ਹੈ; ਕੈਮਰਾ ਫਰੇਮ ਅੱਪਲੋਡ ਨਹੀਂ ਹੁੰਦੇ।',
    consentRequired: 'ਮਲਟੀਪਲੇਅਰ ਕਮਰੇ ਵਿੱਚ ਸ਼ਾਮਲ ਹੋਣ ਤੋਂ ਪਹਿਲਾਂ ਸਹਿਮਤੀ ਲੋੜੀਂਦੀ ਹੈ।',
    cameraPermissionRequest: 'Red Zone ਨਿਸ਼ਾਨੇ ਅਤੇ ਮੈਚ QR ਪੜ੍ਹਨ ਲਈ ਕੈਮਰਾ ਇਜਾਜ਼ਤ ਚਾਹੀਦੀ ਹੈ।',
    cameraPermissionOpenSettings: 'ਕੈਮਰਾ ਇਜਾਜ਼ਤ ਰੋਕੀ ਹੋਈ ਹੈ। ਸੈਟਿੰਗਾਂ ਵਿੱਚ ਇਜਾਜ਼ਤ ਦਿਓ।',
    assignedPlayer: 'ਨਿਯੁਕਤ ਖਿਡਾਰੀ', stickerInstructions: 'ਆਪਣਾ ਸਥਾਈ ਖਿਡਾਰੀ ਸਟਿਕਰ ਫ਼ੋਨ ਦੇ ਪਿੱਛੇ ਸਾਫ਼ ਨਜ਼ਰ ਆਉਣ ਵਾਲੀ ਥਾਂ ਲਗਾਓ ਤਾਂ ਜੋ ਹੋਰ ਪੜ੍ਹ ਸਕਣ।',
    designRange: 'ਡਿਜ਼ਾਈਨ ਦੂਰੀ: 5 ਮੀਟਰ ਤੱਕ। ਅਸਲ ਡਿਵਾਈਸ ’ਤੇ ਜਾਂਚ ਅਜੇ ਲੋੜੀਂਦੀ ਹੈ।', hitTolerance: 'ਨਿਸ਼ਾਨਾ ਹਰ ਪਾਸੇ ਲਗਭਗ 30 ਸੈਂਟੀਮੀਟਰ ਦੀ ਗ਼ਲਤੀ ਸਹਿੰਦਾ ਹੈ; ਬਿਲਕੁਲ ਕੇਂਦਰ ਜ਼ਰੂਰੀ ਨਹੀਂ।',
    networkContinuity: 'ਨਵਾਂ QR ਨੈੱਟਵਰਕ ਨਿਸ਼ਾਨਾ ਚੁਣਦਾ ਹੈ। QR ਥੋੜ੍ਹੀ ਦੇਰ ਨਾ ਪੜ੍ਹੇ ਤਾਂ ਲੌਕ ਜਾਰੀ ਰਹਿੰਦਾ ਹੈ। ਇੱਕ ਜਿਊਂਦਾ ਵਿਰੋਧੀ ਹੋਵੇ ਤਾਂ ਉਹ ਆਪਣੇ ਆਪ ਚੁਣਿਆ ਜਾਂਦਾ ਹੈ।',
    matchJoinQr: 'ਮੈਚ ਵਿੱਚ ਸ਼ਾਮਲ ਹੋਣ ਲਈ QR', scanJoinQr: 'ਮੈਚ QR ਸਕੈਨ ਕਰੋ', manualCodeFallback: 'ਜਾਂ ਕਮਰੇ ਦਾ ਕੋਡ ਹੱਥੀਂ ਦਿਓ।',
    targetPdf: 'ਖਿਡਾਰੀ ਨਿਸ਼ਾਨਾ PDF', viewPdf: 'PDF ਵੇਖੋ', printPdf: 'ਪ੍ਰਿੰਟ', sharePdf: 'ਸਾਂਝਾ ਕਰੋ',
    sharingUnavailable: 'ਇਸ ਡਿਵਾਈਸ ’ਤੇ ਸਾਂਝਾ ਕਰਨਾ ਉਪਲਬਧ ਨਹੀਂ।', sharingFailed: 'PDF ਸਾਂਝੀ ਨਹੀਂ ਹੋ ਸਕੀ।', printingFailed: 'PDF ਪ੍ਰਿੰਟ ਨਹੀਂ ਹੋ ਸਕੀ।',
    scanJoinQrHint: 'ਹੋਸਟ ਦੇ ਮੈਚ QR ਵੱਲ ਕੈਮਰਾ ਕਰੋ। ਕੋਡ ਵਿੱਚ ਸੈਸ਼ਨ ਟੋਕਨ ਨਹੀਂ ਹੈ।', invalidJoinQr: 'ਇਹ ਵੈਧ Red Zone ਮੈਚ QR ਨਹੀਂ ਹੈ।',
  },
  id: {
    battleConsent: 'Saya setuju server menyinkronkan status ruang, pemain, dan pertempuran. Kamera membaca QR Red Zone di perangkat ini; bingkai kamera tidak diunggah.',
    consentRequired: 'Persetujuan diperlukan sebelum bergabung ke ruang multipemain.',
    cameraPermissionRequest: 'Akses kamera diperlukan untuk membaca target Red Zone dan QR pertandingan.',
    cameraPermissionOpenSettings: 'Akses kamera diblokir. Izinkan di Pengaturan.',
    assignedPlayer: 'Pemain yang ditetapkan', stickerInstructions: 'Tempel stiker pemain permanen dengan jelas di belakang ponsel agar dapat dibaca pemain lain.',
    designRange: 'Jarak desain: hingga 5 m. Validasi dengan perangkat nyata masih diperlukan.', hitTolerance: 'Bidikan menoleransi kesalahan sekitar 30 cm ke setiap arah; tidak harus tepat di tengah.',
    networkContinuity: 'QR baru memilih target jaringan. Jika QR sementara tidak terbaca, kunci tetap berjalan. Jika hanya ada satu lawan hidup, ia dipilih otomatis.',
    matchJoinQr: 'QR bergabung ke pertandingan', scanJoinQr: 'Pindai QR pertandingan', manualCodeFallback: 'Atau masukkan kode ruang secara manual.',
    targetPdf: 'PDF target pemain', viewPdf: 'Lihat PDF', printPdf: 'Cetak', sharePdf: 'Bagikan',
    sharingUnavailable: 'Berbagi tidak tersedia di perangkat ini.', sharingFailed: 'PDF tidak dapat dibagikan.', printingFailed: 'PDF tidak dapat dicetak.',
    scanJoinQrHint: 'Arahkan kamera ke QR pertandingan milik host. Kode tidak berisi token sesi.', invalidJoinQr: 'Ini bukan QR pertandingan Red Zone yang valid.',
  },
  ko: {
    battleConsent: '서버가 방, 플레이어, 전투 상태를 동기화하는 데 동의합니다. 카메라는 이 기기에서 Red Zone QR을 읽으며 카메라 영상은 업로드되지 않습니다.',
    consentRequired: '멀티플레이어 방에 참여하려면 먼저 동의해야 합니다.',
    cameraPermissionRequest: 'Red Zone 대상과 경기 QR을 읽으려면 카메라 권한이 필요합니다.',
    cameraPermissionOpenSettings: '카메라 권한이 차단되었습니다. 설정에서 허용하세요.',
    assignedPlayer: '배정된 플레이어', stickerInstructions: '다른 플레이어가 읽을 수 있도록 영구 플레이어 스티커를 휴대폰 뒷면에 잘 보이게 붙이세요.',
    designRange: '설계 거리: 최대 5m. 실제 기기 검증이 필요합니다.', hitTolerance: '조준점은 모든 방향에서 약 30cm 오차를 허용하며 정확한 중앙이 아니어도 됩니다.',
    networkContinuity: '새 QR이 네트워크 대상을 선택합니다. QR을 잠시 읽지 못해도 잠금은 유지됩니다. 살아 있는 상대가 한 명이면 자동 선택합니다.',
    matchJoinQr: '경기 참가 QR', scanJoinQr: '경기 QR 스캔', manualCodeFallback: '또는 방 코드를 직접 입력하세요.',
    targetPdf: '플레이어 대상 PDF', viewPdf: 'PDF 보기', printPdf: '인쇄', sharePdf: '공유',
    sharingUnavailable: '이 기기에서는 공유할 수 없습니다.', sharingFailed: 'PDF를 공유하지 못했습니다.', printingFailed: 'PDF를 인쇄하지 못했습니다.',
    scanJoinQrHint: '호스트의 경기 QR에 카메라를 대세요. 코드에는 세션 토큰이 없습니다.', invalidJoinQr: '유효한 Red Zone 경기 QR이 아닙니다.',
  },
  vi: {
    battleConsent: 'Tôi đồng ý để máy chủ đồng bộ trạng thái phòng, người chơi và trận đấu. Camera đọc QR Red Zone trên thiết bị này; khung hình không được tải lên.',
    consentRequired: 'Cần đồng ý trước khi tham gia phòng nhiều người.',
    cameraPermissionRequest: 'Cần quyền camera để đọc mục tiêu Red Zone và QR trận đấu.',
    cameraPermissionOpenSettings: 'Quyền camera đã bị chặn. Hãy cho phép trong Cài đặt.',
    assignedPlayer: 'Người chơi được gán', stickerInstructions: 'Dán nhãn người chơi cố định rõ ràng ở mặt sau điện thoại để người khác đọc được.',
    designRange: 'Khoảng cách thiết kế: tối đa 5 m. Vẫn cần kiểm tra trên thiết bị thật.', hitTolerance: 'Tâm ngắm cho phép sai lệch khoảng 30 cm theo mọi hướng; không cần chính giữa.',
    networkContinuity: 'QR mới chọn mục tiêu mạng. Nếu QR tạm thời không đọc được, khóa mạng vẫn giữ. Nếu chỉ có một đối thủ còn sống, đối thủ đó được chọn tự động.',
    matchJoinQr: 'QR tham gia trận đấu', scanJoinQr: 'Quét QR trận đấu', manualCodeFallback: 'Hoặc nhập mã phòng thủ công.',
    targetPdf: 'PDF mục tiêu người chơi', viewPdf: 'Xem PDF', printPdf: 'In', sharePdf: 'Chia sẻ',
    sharingUnavailable: 'Thiết bị này không hỗ trợ chia sẻ.', sharingFailed: 'Không thể chia sẻ PDF.', printingFailed: 'Không thể in PDF.',
    scanJoinQrHint: 'Hướng camera vào QR trận đấu của chủ phòng. Mã không chứa mã phiên.', invalidJoinQr: 'Đây không phải QR trận đấu Red Zone hợp lệ.',
  },
  th: {
    battleConsent: 'ฉันยอมรับให้เซิร์ฟเวอร์ซิงค์สถานะห้อง ผู้เล่น และการต่อสู้ กล้องอ่าน QR ของ Red Zone บนอุปกรณ์นี้ และจะไม่อัปโหลดภาพจากกล้อง',
    consentRequired: 'ต้องยอมรับก่อนเข้าห้องผู้เล่นหลายคน', cameraPermissionRequest: 'ต้องอนุญาตกล้องเพื่ออ่านเป้าหมาย Red Zone และ QR ของแมตช์',
    cameraPermissionOpenSettings: 'สิทธิ์กล้องถูกบล็อก โปรดอนุญาตในการตั้งค่า', assignedPlayer: 'ผู้เล่นที่ได้รับมอบหมาย',
    stickerInstructions: 'ติดสติกเกอร์ผู้เล่นถาวรไว้ด้านหลังโทรศัพท์ให้มองเห็น เพื่อให้ผู้เล่นอื่นอ่านได้',
    designRange: 'ระยะออกแบบ: สูงสุด 5 ม. ต้องทดสอบกับอุปกรณ์จริงเพิ่มเติม', hitTolerance: 'การเล็งยอมให้คลาดเคลื่อนได้ประมาณ 30 ซม. ทุกทิศทาง ไม่จำเป็นต้องตรงกลาง',
    networkContinuity: 'QR ใหม่จะเลือกเป้าหมายเครือข่าย หากอ่าน QR ไม่ได้ชั่วคราว การล็อกจะยังอยู่ หากมีคู่ต่อสู้ที่ยังมีชีวิตเพียงคนเดียว ระบบจะเลือกให้อัตโนมัติ',
    matchJoinQr: 'QR เข้าร่วมแมตช์', scanJoinQr: 'สแกน QR แมตช์', manualCodeFallback: 'หรือกรอกรหัสห้องเอง',
    targetPdf: 'PDF เป้าหมายผู้เล่น', viewPdf: 'ดู PDF', printPdf: 'พิมพ์', sharePdf: 'แชร์',
    sharingUnavailable: 'อุปกรณ์นี้ไม่รองรับการแชร์', sharingFailed: 'แชร์ PDF ไม่สำเร็จ', printingFailed: 'พิมพ์ PDF ไม่สำเร็จ',
    scanJoinQrHint: 'หันกล้องไปที่ QR แมตช์ของโฮสต์ รหัสไม่มีโทเค็นเซสชัน', invalidJoinQr: 'นี่ไม่ใช่ QR แมตช์ Red Zone ที่ถูกต้อง',
  },
  nl: {
    battleConsent: 'Ik ga ermee akkoord dat de server de kamer-, spelers- en gevechtsstatus synchroniseert. De camera leest Red Zone-QR’s op dit apparaat; camerabeelden worden niet geüpload.',
    consentRequired: 'Toestemming is vereist voordat je een multiplayerkamer betreedt.',
    cameraPermissionRequest: 'Cameratoegang is nodig om Red Zone-doelen en wedstrijd-QR’s te lezen.',
    cameraPermissionOpenSettings: 'Cameratoegang is geblokkeerd. Sta dit toe in Instellingen.',
    assignedPlayer: 'Toegewezen speler', stickerInstructions: 'Bevestig je permanente spelerssticker zichtbaar op de achterkant van je telefoon, zodat anderen hem kunnen lezen.',
    designRange: 'Ontwerpbereik: tot 5 m. Controle met echte apparaten is nog nodig.', hitTolerance: 'Het vizier staat ongeveer 30 cm afwijking in elke richting toe; exact centreren is niet nodig.',
    networkContinuity: 'Een nieuwe QR kiest het netwerkdoel. Als de QR tijdelijk niet leesbaar is, blijft de vergrendeling actief. Bij één levende tegenstander wordt die automatisch gekozen.',
    matchJoinQr: 'QR om aan de wedstrijd deel te nemen', scanJoinQr: 'Wedstrijd-QR scannen', manualCodeFallback: 'Of voer de kamercode handmatig in.',
    targetPdf: 'PDF met spelersdoelen', viewPdf: 'PDF bekijken', printPdf: 'Afdrukken', sharePdf: 'Delen',
    sharingUnavailable: 'Delen is niet beschikbaar op dit apparaat.', sharingFailed: 'De PDF kon niet worden gedeeld.', printingFailed: 'De PDF kon niet worden afgedrukt.',
    scanJoinQrHint: 'Richt de camera op de wedstrijd-QR van de host. De code bevat geen sessietoken.', invalidJoinQr: 'Dit is geen geldige Red Zone-wedstrijd-QR.',
  },
  pl: {
    battleConsent: 'Zgadzam się, aby serwer synchronizował stan pokoju, graczy i walki. Aparat odczytuje kody QR Red Zone na tym urządzeniu; obrazy nie są wysyłane.',
    consentRequired: 'Przed dołączeniem do pokoju wieloosobowego wymagana jest zgoda.',
    cameraPermissionRequest: 'Do odczytu celów Red Zone i kodów QR meczu potrzebny jest aparat.',
    cameraPermissionOpenSettings: 'Dostęp do aparatu jest zablokowany. Zezwól na niego w Ustawieniach.',
    assignedPlayer: 'Przypisany gracz', stickerInstructions: 'Przyklej stałą naklejkę gracza w widocznym miejscu z tyłu telefonu, aby inni mogli ją odczytać.',
    designRange: 'Zasięg projektowy: do 5 m. Nadal wymagana jest próba na prawdziwych urządzeniach.', hitTolerance: 'Celownik toleruje około 30 cm błędu w każdym kierunku; nie trzeba celować idealnie w środek.',
    networkContinuity: 'Nowy QR wybiera cel sieciowy. Gdy QR jest chwilowo nieczytelny, blokada trwa dalej. Przy jednym żywym przeciwniku zostanie on wybrany automatycznie.',
    matchJoinQr: 'QR dołączania do meczu', scanJoinQr: 'Skanuj QR meczu', manualCodeFallback: 'Lub wpisz kod pokoju ręcznie.',
    targetPdf: 'PDF celów graczy', viewPdf: 'Wyświetl PDF', printPdf: 'Drukuj', sharePdf: 'Udostępnij',
    sharingUnavailable: 'Udostępnianie jest niedostępne na tym urządzeniu.', sharingFailed: 'Nie udało się udostępnić PDF.', printingFailed: 'Nie udało się wydrukować PDF.',
    scanJoinQrHint: 'Skieruj aparat na QR meczu gospodarza. Kod nie zawiera tokenu sesji.', invalidJoinQr: 'To nie jest prawidłowy QR meczu Red Zone.',
  },
  sv: {
    battleConsent: 'Jag godkänner att servern synkroniserar rums-, spelar- och stridsstatus. Kameran läser Red Zone-QR på enheten; kamerabilder laddas inte upp.',
    consentRequired: 'Samtycke krävs innan du går med i ett flerspelarrum.',
    cameraPermissionRequest: 'Kameraåtkomst behövs för att läsa Red Zone-mål och match-QR.',
    cameraPermissionOpenSettings: 'Kameraåtkomst är blockerad. Tillåt den i Inställningar.',
    assignedPlayer: 'Tilldelad spelare', stickerInstructions: 'Fäst din permanenta spelarbricka synligt på telefonens baksida så att andra kan läsa den.',
    designRange: 'Designavstånd: upp till 5 m. Test med riktiga enheter återstår.', hitTolerance: 'Siktet tillåter cirka 30 cm fel åt alla håll; exakt centrum krävs inte.',
    networkContinuity: 'En ny QR väljer nätverksmålet. Om QR tillfälligt inte kan läsas fortsätter låset. Med en enda levande motståndare väljs den automatiskt.',
    matchJoinQr: 'QR för att gå med i matchen', scanJoinQr: 'Skanna match-QR', manualCodeFallback: 'Eller ange rumskoden manuellt.',
    targetPdf: 'PDF med spelarmål', viewPdf: 'Visa PDF', printPdf: 'Skriv ut', sharePdf: 'Dela',
    sharingUnavailable: 'Delning är inte tillgänglig på den här enheten.', sharingFailed: 'PDF kunde inte delas.', printingFailed: 'PDF kunde inte skrivas ut.',
    scanJoinQrHint: 'Rikta kameran mot värdens match-QR. Koden innehåller ingen sessionstoken.', invalidJoinQr: 'Detta är inte en giltig Red Zone-match-QR.',
  },
  fa: {
    battleConsent: 'می‌پذیرم که سرور وضعیت اتاق، بازیکنان و نبرد را همگام کند. دوربین QRهای Red Zone را روی این دستگاه می‌خواند و فریم‌ها بارگذاری نمی‌شوند.',
    consentRequired: 'پیش از پیوستن به اتاق چندنفره باید موافقت کنید.',
    cameraPermissionRequest: 'برای خواندن اهداف Red Zone و QR مسابقه، اجازه دوربین لازم است.',
    cameraPermissionOpenSettings: 'دسترسی دوربین مسدود است. آن را در تنظیمات فعال کنید.',
    assignedPlayer: 'بازیکن اختصاص‌یافته', stickerInstructions: 'برچسب دائمی بازیکن را در پشت تلفن، در دید دیگران، بچسبانید.',
    designRange: 'برد طراحی: تا ۵ متر. آزمایش با دستگاه واقعی هنوز لازم است.', hitTolerance: 'نشانه‌گیر در هر جهت حدود ۳۰ سانتی‌متر خطا را می‌پذیرد؛ مرکز دقیق لازم نیست.',
    networkContinuity: 'QR تازه هدف شبکه را انتخاب می‌کند. اگر QR موقتاً خوانده نشود، قفل شبکه ادامه می‌یابد. با یک حریف زنده، او خودکار انتخاب می‌شود.',
    matchJoinQr: 'QR پیوستن به مسابقه', scanJoinQr: 'اسکن QR مسابقه', manualCodeFallback: 'یا کد اتاق را دستی وارد کنید.',
    targetPdf: 'PDF اهداف بازیکنان', viewPdf: 'مشاهده PDF', printPdf: 'چاپ', sharePdf: 'اشتراک‌گذاری',
    sharingUnavailable: 'اشتراک‌گذاری در این دستگاه در دسترس نیست.', sharingFailed: 'اشتراک‌گذاری PDF انجام نشد.', printingFailed: 'چاپ PDF انجام نشد.',
    scanJoinQrHint: 'دوربین را به QR مسابقه میزبان بگیرید. کد توکن نشست ندارد.', invalidJoinQr: 'این QR مسابقه معتبر Red Zone نیست.',
  },
};

const TARGET_TUTORIAL_COPY: Record<Locale, Pick<Record<LobbyCopyKey, string>,
  'tutorialTitle' | 'tutorialStep1' | 'tutorialStep2' | 'tutorialStep3' | 'tutorialStep4' |
  'tutorialCameraWarning' | 'tutorialSkip' | 'tutorialNext' | 'tutorialBack' | 'tutorialDone' | 'howToPrepare'>> = {
  tr: { tutorialTitle: 'Hedef kurulumu', tutorialStep1: 'Hedef PDF dosyasını bilgisayarda veya başka bir cihazda açın.', tutorialStep2: 'Dosyayı tam olarak %100 (gerçek boyut) yazdırın. Sığdırmak için ölçeklendirmeyin.', tutorialStep3: 'Atanan oyuncu numaranızla eşleşen kartı kesin.', tutorialStep4: 'Oyuncu numaranızla eşleşen kartı telefonunuzun arkasına düz biçimde yapıştırın. Kamerayı kapatmayın.', tutorialCameraWarning: 'Uyarı: Kamera açık kalmalıdır.', tutorialSkip: 'ATLA', tutorialNext: 'İLERİ', tutorialBack: 'GERİ', tutorialDone: 'BİTTİ', howToPrepare: 'Nasıl hazırlanır?' },
  en: { tutorialTitle: 'Target setup', tutorialStep1: 'Open the target PDF on a computer or another device.', tutorialStep2: 'Print it at exactly 100% (actual size). Do not scale to fit.', tutorialStep3: 'Cut out the card that matches your assigned player number.', tutorialStep4: 'Attach the card matching your player number flat to the back of your phone. Do not cover the camera.', tutorialCameraWarning: 'Warning: The camera must stay uncovered.', tutorialSkip: 'SKIP', tutorialNext: 'NEXT', tutorialBack: 'BACK', tutorialDone: 'DONE', howToPrepare: 'How to prepare?' },
  zh: { tutorialTitle: '设置目标', tutorialStep1: '在电脑或其他设备上打开目标 PDF。', tutorialStep2: '以 100%（实际大小）打印。不要缩放以适应页面。', tutorialStep3: '剪下与分配给你的玩家编号相匹配的卡片。', tutorialStep4: '将与你的玩家编号相匹配的卡片平贴在手机背面。不要遮挡摄像头。', tutorialCameraWarning: '警告：摄像头必须保持无遮挡。', tutorialSkip: '跳过', tutorialNext: '下一步', tutorialBack: '返回', tutorialDone: '完成', howToPrepare: '如何准备？' },
  ja: { tutorialTitle: 'ターゲット設定', tutorialStep1: 'パソコンなどでターゲットPDFを開きます。', tutorialStep2: '100%（実際のサイズ）で印刷します。用紙に合わせて縮小しないでください。', tutorialStep3: '割り当てられたプレイヤー番号のカードを切り取ります。', tutorialStep4: '自分のプレイヤー番号のカードをスマートフォンの裏面に平らに貼ります。カメラを隠さないでください。', tutorialCameraWarning: '警告: カメラを隠さないでください。', tutorialSkip: 'スキップ', tutorialNext: '次へ', tutorialBack: '戻る', tutorialDone: '完了', howToPrepare: '準備方法' },
  ar: { tutorialTitle: 'إعداد الهدف', tutorialStep1: 'افتح ملف الهدف PDF على الكمبيوتر أو جهاز آخر.', tutorialStep2: 'اطبع الملف بنسبة 100٪ (الحجم الفعلي). لا تغيّر المقياس ليلائم الصفحة.', tutorialStep3: 'اقطع البطاقة المطابقة لرقم اللاعب المخصص لك.', tutorialStep4: 'ثبّت البطاقة المطابقة لرقم لاعبك بشكل مسطح على ظهر الهاتف. لا تغطِّ الكاميرا.', tutorialCameraWarning: 'تحذير: يجب أن تبقى الكاميرا مكشوفة.', tutorialSkip: 'تخطي', tutorialNext: 'التالي', tutorialBack: 'رجوع', tutorialDone: 'تم', howToPrepare: 'كيفية التحضير؟' },
  de: { tutorialTitle: 'Ziel einrichten', tutorialStep1: 'Öffne die Ziel-PDF auf einem Computer oder einem anderen Gerät.', tutorialStep2: 'Drucke sie mit 100 % (Originalgröße). Nicht an die Seite anpassen.', tutorialStep3: 'Schneide die Karte mit deiner zugewiesenen Spielernummer aus.', tutorialStep4: 'Befestige die Karte mit deiner Spielernummer flach auf der Handy-Rückseite. Die Kamera darf nicht verdeckt werden.', tutorialCameraWarning: 'Warnung: Die Kamera muss frei bleiben.', tutorialSkip: 'ÜBERSPRINGEN', tutorialNext: 'WEITER', tutorialBack: 'ZURÜCK', tutorialDone: 'FERTIG', howToPrepare: 'Wie bereite ich mich vor?' },
  fr: { tutorialTitle: 'Configurer la cible', tutorialStep1: 'Ouvrez le PDF de la cible sur un ordinateur ou un autre appareil.', tutorialStep2: 'Imprimez-le à 100 % (taille réelle). Ne l’ajustez pas à la page.', tutorialStep3: 'Découpez la carte correspondant à votre numéro de joueur.', tutorialStep4: 'Fixez cette carte à plat au dos du téléphone. Ne couvrez pas l’appareil photo.', tutorialCameraWarning: 'Avertissement : l’appareil photo doit rester dégagé.', tutorialSkip: 'PASSER', tutorialNext: 'SUIVANT', tutorialBack: 'RETOUR', tutorialDone: 'TERMINÉ', howToPrepare: 'Comment se préparer ?' },
  es: { tutorialTitle: 'Configurar objetivo', tutorialStep1: 'Abre el PDF del objetivo en un ordenador u otro dispositivo.', tutorialStep2: 'Imprímelo al 100 % (tamaño real). No lo escales para ajustarlo.', tutorialStep3: 'Recorta la tarjeta que coincide con tu número de jugador.', tutorialStep4: 'Pega esa tarjeta plana en la parte trasera del teléfono. No cubras la cámara.', tutorialCameraWarning: 'Advertencia: la cámara debe quedar descubierta.', tutorialSkip: 'SALTAR', tutorialNext: 'SIGUIENTE', tutorialBack: 'ATRÁS', tutorialDone: 'LISTO', howToPrepare: '¿Cómo prepararse?' },
  it: { tutorialTitle: 'Impostazione bersaglio', tutorialStep1: 'Apri il PDF del bersaglio su un computer o altro dispositivo.', tutorialStep2: 'Stampalo al 100% (dimensioni reali). Non adattarlo alla pagina.', tutorialStep3: 'Ritaglia la scheda che corrisponde al tuo numero giocatore.', tutorialStep4: 'Fissa la scheda piatta sul retro del telefono. Non coprire la fotocamera.', tutorialCameraWarning: 'Attenzione: la fotocamera deve restare scoperta.', tutorialSkip: 'SALTA', tutorialNext: 'AVANTI', tutorialBack: 'INDIETRO', tutorialDone: 'FATTO', howToPrepare: 'Come prepararsi?' },
  pt: { tutorialTitle: 'Configurar alvo', tutorialStep1: 'Abra o PDF do alvo num computador ou noutro dispositivo.', tutorialStep2: 'Imprima a 100% (tamanho real). Não ajuste à página.', tutorialStep3: 'Recorte o cartão correspondente ao seu número de jogador.', tutorialStep4: 'Cole o cartão correspondente, bem plano, na parte de trás do telemóvel. Não cubra a câmara.', tutorialCameraWarning: 'Aviso: a câmara deve ficar descoberta.', tutorialSkip: 'SALTAR', tutorialNext: 'SEGUINTE', tutorialBack: 'VOLTAR', tutorialDone: 'CONCLUÍDO', howToPrepare: 'Como preparar?' },
  ru: { tutorialTitle: 'Настройка цели', tutorialStep1: 'Откройте PDF цели на компьютере или другом устройстве.', tutorialStep2: 'Распечатайте его в масштабе 100% (реальный размер). Не подгоняйте под страницу.', tutorialStep3: 'Вырежьте карточку со своим номером игрока.', tutorialStep4: 'Ровно прикрепите карточку со своим номером к задней панели телефона. Не закрывайте камеру.', tutorialCameraWarning: 'Внимание: камера должна оставаться открытой.', tutorialSkip: 'ПРОПУСТИТЬ', tutorialNext: 'ДАЛЕЕ', tutorialBack: 'НАЗАД', tutorialDone: 'ГОТОВО', howToPrepare: 'Как подготовиться?' },
  uk: { tutorialTitle: 'Налаштування цілі', tutorialStep1: 'Відкрийте PDF цілі на комп’ютері або іншому пристрої.', tutorialStep2: 'Роздрукуйте його у масштабі 100% (реальний розмір). Не масштабуйте під сторінку.', tutorialStep3: 'Виріжте картку зі своїм номером гравця.', tutorialStep4: 'Рівно прикріпіть картку зі своїм номером до задньої панелі телефона. Не закривайте камеру.', tutorialCameraWarning: 'Увага: камера має залишатися відкритою.', tutorialSkip: 'ПРОПУСТИТИ', tutorialNext: 'ДАЛІ', tutorialBack: 'НАЗАД', tutorialDone: 'ГОТОВО', howToPrepare: 'Як підготуватися?' },
  hi: { tutorialTitle: 'लक्ष्य सेटअप', tutorialStep1: 'कंप्यूटर या अन्य डिवाइस पर लक्ष्य PDF खोलें।', tutorialStep2: 'इसे 100% (वास्तविक आकार) पर प्रिंट करें। फिट करने के लिए स्केल न करें।', tutorialStep3: 'अपने निर्धारित खिलाड़ी नंबर वाला कार्ड काटें।', tutorialStep4: 'अपने नंबर वाला कार्ड फोन के पीछे सपाट लगाएं। कैमरा न ढकें।', tutorialCameraWarning: 'चेतावनी: कैमरा खुला रहना चाहिए।', tutorialSkip: 'छोड़ें', tutorialNext: 'आगे', tutorialBack: 'पीछे', tutorialDone: 'हो गया', howToPrepare: 'तैयारी कैसे करें?' },
  ur: { tutorialTitle: 'ہدف کی ترتیب', tutorialStep1: 'ہدف کی PDF کمپیوٹر یا کسی دوسرے آلے پر کھولیں۔', tutorialStep2: 'اسے 100٪ (اصل سائز) پر پرنٹ کریں۔ صفحے کے مطابق اسکیل نہ کریں۔', tutorialStep3: 'اپنے مختص کھلاڑی نمبر والا کارڈ کاٹیں۔', tutorialStep4: 'اپنے نمبر والا کارڈ فون کی پشت پر سیدھا لگائیں۔ کیمرہ نہ ڈھانپیں۔', tutorialCameraWarning: 'انتباہ: کیمرہ کھلا رہنا چاہیے۔', tutorialSkip: 'چھوڑیں', tutorialNext: 'اگلا', tutorialBack: 'پیچھے', tutorialDone: 'ہو گیا', howToPrepare: 'تیاری کیسے کریں؟' },
  bn: { tutorialTitle: 'লক্ষ্য সেটআপ', tutorialStep1: 'কম্পিউটার বা অন্য ডিভাইসে লক্ষ্য PDF খুলুন।', tutorialStep2: 'এটি ১০০% (আসল আকারে) প্রিন্ট করুন। মানানসই করতে স্কেল করবেন না।', tutorialStep3: 'আপনার নির্ধারিত খেলোয়াড় নম্বরের কার্ডটি কাটুন।', tutorialStep4: 'আপনার নম্বরের কার্ডটি ফোনের পেছনে সমতলভাবে লাগান। ক্যামেরা ঢাকবেন না।', tutorialCameraWarning: 'সতর্কতা: ক্যামেরা খোলা রাখতে হবে।', tutorialSkip: 'এড়িয়ে যান', tutorialNext: 'পরবর্তী', tutorialBack: 'পেছনে', tutorialDone: 'সম্পন্ন', howToPrepare: 'কীভাবে প্রস্তুত করবেন?' },
  pa: { tutorialTitle: 'ਨਿਸ਼ਾਨਾ ਸੈੱਟਅੱਪ', tutorialStep1: 'ਕੰਪਿਊਟਰ ਜਾਂ ਹੋਰ ਡਿਵਾਈਸ ਉੱਤੇ ਨਿਸ਼ਾਨਾ PDF ਖੋਲ੍ਹੋ।', tutorialStep2: 'ਇਸਨੂੰ 100% (ਅਸਲ ਆਕਾਰ) ਉੱਤੇ ਪ੍ਰਿੰਟ ਕਰੋ। ਫਿੱਟ ਕਰਨ ਲਈ ਸਕੇਲ ਨਾ ਕਰੋ।', tutorialStep3: 'ਆਪਣੇ ਨਿਰਧਾਰਤ ਖਿਡਾਰੀ ਨੰਬਰ ਵਾਲਾ ਕਾਰਡ ਕੱਟੋ।', tutorialStep4: 'ਆਪਣੇ ਨੰਬਰ ਵਾਲਾ ਕਾਰਡ ਫ਼ੋਨ ਦੇ ਪਿਛਲੇ ਪਾਸੇ ਸਿੱਧਾ ਲਗਾਓ। ਕੈਮਰਾ ਨਾ ਢੱਕੋ।', tutorialCameraWarning: 'ਚੇਤਾਵਨੀ: ਕੈਮਰਾ ਖੁੱਲ੍ਹਾ ਰਹਿਣਾ ਚਾਹੀਦਾ ਹੈ।', tutorialSkip: 'ਛੱਡੋ', tutorialNext: 'ਅਗਲਾ', tutorialBack: 'ਪਿੱਛੇ', tutorialDone: 'ਹੋ ਗਿਆ', howToPrepare: 'ਤਿਆਰੀ ਕਿਵੇਂ ਕਰੀਏ?' },
  id: { tutorialTitle: 'Pengaturan target', tutorialStep1: 'Buka PDF target di komputer atau perangkat lain.', tutorialStep2: 'Cetak tepat 100% (ukuran sebenarnya). Jangan sesuaikan dengan halaman.', tutorialStep3: 'Potong kartu yang sesuai dengan nomor pemain Anda.', tutorialStep4: 'Tempelkan kartu dengan nomor Anda rata di belakang ponsel. Jangan tutupi kamera.', tutorialCameraWarning: 'Peringatan: kamera harus tetap terbuka.', tutorialSkip: 'LEWATI', tutorialNext: 'LANJUT', tutorialBack: 'KEMBALI', tutorialDone: 'SELESAI', howToPrepare: 'Bagaimana cara menyiapkan?' },
  ko: { tutorialTitle: '타겟 설정', tutorialStep1: '컴퓨터나 다른 기기에서 타겟 PDF를 엽니다.', tutorialStep2: '100%(실제 크기)로 인쇄합니다. 페이지에 맞게 조정하지 마세요.', tutorialStep3: '배정된 플레이어 번호의 카드를 오려냅니다.', tutorialStep4: '내 번호의 카드를 휴대폰 뒷면에 평평하게 붙입니다. 카메라를 가리지 마세요.', tutorialCameraWarning: '경고: 카메라를 가리지 않아야 합니다.', tutorialSkip: '건너뛰기', tutorialNext: '다음', tutorialBack: '뒤로', tutorialDone: '완료', howToPrepare: '어떻게 준비하나요?' },
  vi: { tutorialTitle: 'Thiết lập mục tiêu', tutorialStep1: 'Mở PDF mục tiêu trên máy tính hoặc thiết bị khác.', tutorialStep2: 'In đúng 100% (kích thước thật). Không co giãn để vừa trang.', tutorialStep3: 'Cắt thẻ có số người chơi được giao cho bạn.', tutorialStep4: 'Dán phẳng thẻ có số của bạn vào mặt sau điện thoại. Không che camera.', tutorialCameraWarning: 'Cảnh báo: Camera phải luôn thông thoáng.', tutorialSkip: 'BỎ QUA', tutorialNext: 'TIẾP THEO', tutorialBack: 'QUAY LẠI', tutorialDone: 'XONG', howToPrepare: 'Cách chuẩn bị?' },
  th: { tutorialTitle: 'ตั้งค่าเป้าหมาย', tutorialStep1: 'เปิด PDF เป้าหมายบนคอมพิวเตอร์หรืออุปกรณ์อื่น', tutorialStep2: 'พิมพ์ที่ 100% (ขนาดจริง) ห้ามปรับให้พอดีหน้า', tutorialStep3: 'ตัดการ์ดที่ตรงกับหมายเลขผู้เล่นของคุณ', tutorialStep4: 'ติดการ์ดหมายเลขของคุณให้เรียบที่ด้านหลังโทรศัพท์ ห้ามบังกล้อง', tutorialCameraWarning: 'คำเตือน: ต้องเปิดกล้องไว้เสมอ', tutorialSkip: 'ข้าม', tutorialNext: 'ถัดไป', tutorialBack: 'กลับ', tutorialDone: 'เสร็จสิ้น', howToPrepare: 'เตรียมตัวอย่างไร?' },
  nl: { tutorialTitle: 'Doel instellen', tutorialStep1: 'Open de doel-PDF op een computer of ander apparaat.', tutorialStep2: 'Print precies op 100% (ware grootte). Pas niet aan de pagina aan.', tutorialStep3: 'Knip de kaart met jouw toegewezen spelersnummer uit.', tutorialStep4: 'Bevestig de kaart met jouw nummer vlak op de achterkant van je telefoon. Bedek de camera niet.', tutorialCameraWarning: 'Waarschuwing: de camera moet vrij blijven.', tutorialSkip: 'OVERSLAAN', tutorialNext: 'VOLGENDE', tutorialBack: 'TERUG', tutorialDone: 'KLAAR', howToPrepare: 'Hoe bereid ik me voor?' },
  pl: { tutorialTitle: 'Konfiguracja celu', tutorialStep1: 'Otwórz PDF celu na komputerze lub innym urządzeniu.', tutorialStep2: 'Wydrukuj go w 100% (rzeczywisty rozmiar). Nie dopasowuj do strony.', tutorialStep3: 'Wytnij kartę z przypisanym numerem gracza.', tutorialStep4: 'Przymocuj kartę z numerem płasko do tyłu telefonu. Nie zasłaniaj aparatu.', tutorialCameraWarning: 'Ostrzeżenie: aparat musi pozostać odsłonięty.', tutorialSkip: 'POMIŃ', tutorialNext: 'DALEJ', tutorialBack: 'WSTECZ', tutorialDone: 'GOTOWE', howToPrepare: 'Jak się przygotować?' },
  sv: { tutorialTitle: 'Ställ in mål', tutorialStep1: 'Öppna mål-PDF:en på en dator eller annan enhet.', tutorialStep2: 'Skriv ut exakt i 100 % (verklig storlek). Anpassa inte till sidan.', tutorialStep3: 'Klipp ut kortet med ditt tilldelade spelarnummer.', tutorialStep4: 'Fäst kortet med ditt nummer plant på telefonens baksida. Täck inte kameran.', tutorialCameraWarning: 'Varning: Kameran måste vara fri.', tutorialSkip: 'HOPPA ÖVER', tutorialNext: 'NÄSTA', tutorialBack: 'TILLBAKA', tutorialDone: 'KLART', howToPrepare: 'Hur förbereder jag mig?' },
  fa: { tutorialTitle: 'تنظیم هدف', tutorialStep1: 'PDF هدف را در رایانه یا دستگاه دیگری باز کنید.', tutorialStep2: 'آن را دقیقاً با ۱۰۰٪ (اندازه واقعی) چاپ کنید. برای جا شدن مقیاس ندهید.', tutorialStep3: 'کارت دارای شماره بازیکن اختصاص‌یافته را ببرید.', tutorialStep4: 'کارت دارای شماره خود را صاف به پشت گوشی بچسبانید. دوربین را نپوشانید.', tutorialCameraWarning: 'هشدار: دوربین باید بدون پوشش بماند.', tutorialSkip: 'رد کردن', tutorialNext: 'بعدی', tutorialBack: 'بازگشت', tutorialDone: 'انجام شد', howToPrepare: 'چگونه آماده شویم؟' },
};

for (const locale of SUPPORTED_LOCALES) {
  Object.assign(LOBBY_COPY_LOCALIZED[locale], TARGET_TUTORIAL_COPY[locale]);
}

const LOBBY_COPY: Record<Locale, Record<LobbyCopyKey, string>> = LOBBY_COPY_LOCALIZED as Record<Locale, Record<LobbyCopyKey, string>>;
...
export function uiText(locale: Locale, key: UiCopyKey): string {
  if (key in LOBBY_COPY[locale]) return LOBBY_COPY[locale][key as LobbyCopyKey];
  if (key in PERMISSION_COPY[locale]) return PERMISSION_COPY[locale][key as PermissionUiCopyKey];
  return UI_COPY[locale][key as Exclude<UiCopyKey, PermissionUiCopyKey | LobbyCopyKey>];
}